...
following in their [`src/index.js`](webapp/src/index.js) file:
...
1. Users aren't always familiar with offline-first web apps. It can be useful to
   ...
   starting point, you can make use of the logic included in [`src/serviceWorker.js`](webapp/src/serviceWorker.js), which
